...
from storage import (
    load_storage, save_storage, find_invitation_by_hash, find_group_by_id,
...
def guests_page():
    ...
    ui.page_title('Uitnodigingen Beheer')
    ...
    with ui.column().classes('max-w-6xl mx-auto p-6'):
        # Header
        ui.label('Uitnodigingen Beheer').classes('text-3xl font-bold mb-6')
        ...
        def invitations_table():
            ...
            if not page_state['invitations']:
                ...
                with ui.card().classes('w-full'):
                    ui.label('Huidige Uitnodigingen').classes('text-xl font-semibold mb-4')
