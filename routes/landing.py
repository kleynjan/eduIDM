...
def landing_page():
    ...
    with ui.column().classes('w-full min-h-screen bg-gray-50'):
        # Content wrapper
        with ui.column().classes('mx-auto p-8 max-w-4xl'):
            ...
            with ui.row().classes('w-full gap-4 justify-center'):
                ...
                with ui.card().classes('p-8 hover:shadow-xl transition-shadow cursor-pointer').style('width: 300px') as accept_card:
                ...
                # Beheer card
                with ui.card().classes('p-8 hover:shadow-xl transition-shadow cursor-pointer').style('width: 300px') as beheer_card:
                    with ui.column().classes('gap-2'):
